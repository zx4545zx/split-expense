...
<div class="fixed top-4 right-4 z-[100] flex flex-col gap-2 max-w-sm">
  {#each $toastStore as toast (toast.id)}
    <div
      class="flex items-start gap-3 p-4 rounded-xl border shadow-lg {styles[toast.type]}"
    ...
    >
      ...
      <button
        ...
        class="flex-shrink-0 -mr-1 -mt-1 p-1 rounded-lg opacity-60 hover:opacity-100 hover:bg-black/5 transition-all"
